		...
		.ready(
				function() {
					...
					function ilid(pno) {
						...
						var str = "";
						str += "<div class='title'>상품문의</div>";

						$
								.getJSON(
										"/inquirylist/" + pno + ".json",
										function(data) {
											str += `<div id="Iwritelink">`;
											if (idVal != "" && idVal != 'aaaaa') {
											...
											if (data == "") {
												...
												for (var i = 0; i < data.length; i++) {
													...
													if (data[i].answer != null) {
														str += "<td id='complete'>답변완료</td></tr>";
													} else {
														str += "<td id='notcomplete'>미답변</td></tr>";
													}
													str += "<tr><th>문의</th>";
													// question
													if (sc == 1) {
